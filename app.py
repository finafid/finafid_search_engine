...
def search_products(query):
    ...
    return filtered_results[['Product', 'Maincategory', 'Subcategory', 'Producttype', 'Brand']]
...
# Streamlit web app
img = Image.open('finafid.png')
st.image(img, width=250)
st.title("Search Engine and Product Recommendation System ON FINAFID Data")
